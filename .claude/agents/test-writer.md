...
3. Read the code under test in full, including its callers and what it depends on. If the code under test doesn't exist yet (test-first), write from the spec / ADRs / schema docs instead.
